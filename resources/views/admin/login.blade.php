...
<body class="card-no-border" style="background: #f6f9fa; min-height:625px;">
    ...
    <div class="container login">
        <div class="row">
            ...
            <div class="card col-md-6">
                <!-- Tab panes -->
                <div class="card-body">
                    <form class="form-horizontal form-material mx-2" method="POST" action="{{route('admin.login.post')}}">
                        @csrf
            
                        <div class="form-group mx-2">
                            @error('username') <span class="validation_message">{{ $message }}</span> @enderror
                            <div>
                                <input name="username" type="text" lang="en" placeholder="أكتب اسم المستخدم" class="form-control form-control-line">
                            </div>
                        </div>
            
                        <div class="form-group mx-2">
                            @error('password') <span class="validation_message">{{ $message }}</span> @enderror
                            <div>
                                <input name="password" type="password" placeholder="أكتب كلمة المرور" class="form-control form-control-line">
                            </div>
                        </div>
            
                        <div class="form-group mx-2">
                            <div>
                                <button type="submit" class="btn btn-primary"><i class="fa fa-sigin"></i> تسجيل الدخول</button>
                            </div>
                        </div>
                    </form>
                </div>
